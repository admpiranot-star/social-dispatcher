...
const DEFAULT_CONFIG: CuratorConfig = {
  ...
  categoryMap: {
    ...
    'novelas': 'entertainment', 'cinema': 'entertainment', 'musica': 'entertainment',
    'arte-cultura': 'entertainment', 'big-brother-brasil': 'entertainment',
    'a-fazenda': 'entertainment', 'curiosidades': 'entertainment',
    'economia': 'economy', 'negocios': 'economy',
    'esporte': 'sports', 'futebol': 'sports',
    'tecnologia': 'technology', 'ciencia': 'technology',
    'loteria': 'lotteries', 'lotofacil': 'lotteries', 'mega-sena': 'lotteries',
    'quina': 'lotteries', 'dupla-sena': 'lotteries', 'dia-de-sorte': 'lotteries',
    'timemania': 'lotteries',
    'piracicaba': 'police', 'campinas': 'police', 'sorocaba': 'police',
    'sumare': 'police', 'indaiatuba': 'police', 'limeira': 'police',
    'rio-claro': 'police', 'estado-sao-paulo': 'police',
    'charqueada': 'police', 'capivari': 'police', 'iracemapolis': 'police',
    'elias-fausto': 'police', 'mombuca': 'police', 'aguas-de-sao-pedro': 'police',
    'sao-pedro': 'police', 'policial': 'police', 'policia': 'police',
    'empregos': 'jobs', 'vagas': 'jobs', 'concursos': 'jobs', 'carreira': 'jobs',
    'receitas': 'recipes', 'culinaria': 'recipes', 'gastronomia': 'recipes',
    'noticias': 'other', 'brasil': 'other', 'mundo': 'other',
    'educacao': 'other', 'saude': 'other', 'colunas': 'other',
    'meio-ambiente': 'other', 'mobilidade-urbana': 'other',
    'editorial': 'other', 'analise-opiniao': 'other', 'especial': 'other',
    'eleicoes': 'other', 'manchetes-do-dia': 'other',
    'necrologia-de-piracicaba': 'other', 'religiao': 'other',
    'automoveis': 'other', 'motos': 'other',
  },
  skipCategories: [
    'uncategorized',
    'sem-categoria',
